...
requiredModules = { ...
    'module2_pinn_network', ...
    'module2_pinn_loss', ...
    'module2_pinn_train', ...
    'module2_pinn_predict', ...
    'module2_pinn_make_dataset', ...
    'module2_pinn_verify'};
for moduleIndex = 1:numel(requiredModules)
    assert(exist(requiredModules{moduleIndex}, 'file') == 2, ...
        'Missing modular Module 2 PINN file: %s.m', ...
        requiredModules{moduleIndex});
end
