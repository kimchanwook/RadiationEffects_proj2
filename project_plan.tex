...
\begin{enumerate}[leftmargin=1.6em]
    ...
    \item \textbf{Module 9:} transmon geometry definition and 2D FEM target-domain tagging for the superconducting-device extension.
\end{enumerate}
...
\path{matlab/} & MATLAB drivers, source code, tests, outputs, and cross-module interfaces for Modules 2--7; Module 9 currently supplies geometry documentation for the next MATLAB extension.\\
\bottomrule
\end{longtable}
