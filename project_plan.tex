...
\path{matlab/tests/} & Verification problems and regression tests, including Module 2 electrostatic limiting-case checks, Module 3 FEM diffusion-reaction checks, Module 4 FEM thermal checks, and Module 5 FEM carrier-transport checks.\\
