...
\begin{enumerate}[leftmargin=1.6em]
    ...
    \item \textbf{Module 2:} 2D electrostatics with prescribed charged defects; first FEM Poisson path now implemented and ready for coupling to Module 3 defect fields.
...
\path{matlab/src/module2_electrostatics/} & Implemented Module 2 finite-element Poisson operators, triangular mesh generation, charge assembly, boundary-condition insertion, and field postprocessing.\\
